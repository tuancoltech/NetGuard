...
public class ActivityMain extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String ACTION_RULES_CHANGED = "anom.netguard.ACTION_RULES_CHANGED";
    public static final String ACTION_QUEUE_CHANGED = "anom.netguard.ACTION_QUEUE_CHANGED";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Disable user from touching application screen
